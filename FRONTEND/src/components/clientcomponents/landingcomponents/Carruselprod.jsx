              ...
              >
                <div className="carruselprod-card bg-white rounded-xl shadow-md flex flex-col overflow-hidden h-[480px] mx-auto">
                  ...
                  <div className="carruselprod-info p-4 flex flex-col justify-between flex-grow">
                    <div>
                      <h3 className="carruselprod-title text-lg font-semibold">
                        {producto.nombre_producto}
                      </h3>
                      <h2 className="carruselprod-price text-xl font-bold text-gray-800 mt-2">
                        ${producto.precio}
                      </h2>
                      <p className="carruselprod-desc text-gray-500 text-sm mt-1">
                        {producto.nombre_categoria}
                      </p>
                      <div className="carrusel-btn-wrapper">
                        <button
                          onClick={() => navigate("/Catalogo")}
                          className="carruselCart "
                        >
